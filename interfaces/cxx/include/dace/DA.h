...
public:
    ...
    *********************************************************************************/
    ...
    DA SphericalHarmonic(const unsigned int n, const unsigned int m) const;
    DA BetaFunction(const DA &da2) const;
    /** @} */
...
DACE_API DA SphericalHarmonic(const unsigned int n, const unsigned int m, const DA &da);
DACE_API DA BetaFunction(const DA &da1, const DA &da2);
/** @} */
