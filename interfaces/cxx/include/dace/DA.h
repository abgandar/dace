...
DACE_API DA cyl_bessel_i(const int n, const DA &da);
DACE_API DA cyl_bessel_j(const int n, const DA &da);
DACE_API DA cyl_bessel_k(const int n, const DA &da);
DACE_API DA cyl_neumann(const int n, const DA &da);
