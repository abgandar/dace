...
public:
    ...
    *********************************************************************************/
    ...
    AlgebraicVector<T> AssociatedLegendrePolynomial(const unsigned int n, const unsigned int m) const;
    ...
    AlgebraicVector<T> SphericalHarmonic(const unsigned int n, const unsigned int m) const;
