...
DACE_API void daceAssociatedLegendrePolynomial(const DACEDA REF(ina), const unsigned int n, const unsigned int m, DACEDA REF(inc));
...
DACE_API void daceSphericalHarmonic(const DACEDA REF(ina), const unsigned int n, const unsigned int m, DACEDA REF(inc));
