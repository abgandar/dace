...
/*! @file
    ...
    @brief Internal DACE core error handling.

    This file contains the error messages for error codes generated by the DACE core.
...
typedef struct {
 ...
 /*! Array of all errors strings and codes generated by the DACE core */
